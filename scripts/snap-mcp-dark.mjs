...
await p.screenshot({path:'/tmp/mcp-prod-dark.png', fullPage: false});
console.log('✓ mcp-prod-dark.png');
...
await proto.screenshot({path:'/tmp/mcp-proto-dark.png', fullPage: false});
console.log('✓ mcp-proto-dark.png');
