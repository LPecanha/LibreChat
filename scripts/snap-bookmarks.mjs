...
await p.goto('http://localhost:3090/bookmarks');
await p.waitForTimeout(2500);
await p.screenshot({path:'/tmp/bookmarks-prod-light.png', fullPage: false});
...
await proto.evaluate(()=>window.showView?.('bookmarks'));
await proto.waitForTimeout(600);
await proto.screenshot({path:'/tmp/bookmarks-proto-light.png', fullPage: false});
await b.close();
console.log('done');
