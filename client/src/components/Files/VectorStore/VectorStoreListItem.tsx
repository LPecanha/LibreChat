...
export default function VectorStoreListItem({
  ...
  return (
    <div
      ...
      className="w-100 mt-2 flex cursor-pointer flex-row justify-around rounded-md border border-0 bg-white p-4 transition duration-300 ease-in-out hover:bg-surface-hover"
    >
