              ...
              <TableRow key={headerGroup.id}>
                {headerGroup.headers.map((header, index) => {
                  ...
                  return (
                    <TableHead
                      key={header.id}
                      className="align-start sticky top-0 rounded-t border-b border-black/10 bg-white px-2 py-1 text-left font-medium text-text-secondary dark:border-white/10 dark:bg-surface-secondary dark:text-text-primary sm:px-4 sm:py-2"
                      style={style}
                    >
            ...
            {table.getRowModel().rows.length ? (
              table.getRowModel().rows.map((row) => (
                <TableRow
                  ...
                  className="border-b border-black/10 text-left text-text-secondary dark:border-white/10 dark:text-text-secondary [tr:last-child_&]:border-b-0"
                >
