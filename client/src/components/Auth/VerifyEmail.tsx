...
function RequestPasswordReset() {
  ...
  const VerificationSuccess = () => (
    <div className="flex flex-col items-center justify-center">
      <h1 className="mb-4 text-center text-3xl font-bold font-display text-text-primary">
        {headerText}
      </h1>
      {countdown > 0 && (
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-white pt-6 dark:bg-surface-primary sm:pt-0">
