      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="flex items-center justify-between">
          <button
            ...
            disabled={isLoading}
            className="w-full rounded-2xl bg-brand px-4 py-3 text-sm font-medium text-white transition-colors hover:opacity-90 disabled:opacity-80 dark:bg-brand dark:hover:opacity-90"
          >
