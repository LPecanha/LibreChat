    ...
    startupConfig.socialLoginEnabled && (
      <>
        {startupConfig.emailLoginEnabled && (
          <>
            <div className="relative mt-6 flex w-full items-center justify-center border border-t border-border-medium uppercase dark:border-border-medium">
              <div className="absolute bg-white px-3 text-xs text-black dark:bg-surface-primary dark:text-white">
                Or
              </div>
            </div>
            <div className="mt-8" />
