...
const EditPresetDialog = ({
  ...
  return (
    <OGDialog open={presetModalVisible} onOpenChange={handleOpenChange} triggerRef={triggerRef}>
      <OGDialogContent className="h-[100dvh] max-h-[100dvh] w-full max-w-full overflow-y-auto bg-white dark:border-border-light dark:bg-gray-850 dark:text-text-secondary md:h-auto md:max-h-[90vh] md:max-w-[75vw] md:rounded-lg lg:max-w-[950px]">
        <OGDialogTitle>
        ...
        <div className="flex w-full flex-col gap-2 px-1 pb-4 md:gap-4">
          ...
          <div className="flex justify-end gap-2 border-t border-border-medium pt-2 md:pt-4">
            <button
              ...
              className="rounded-md border border-border-medium bg-white px-3 py-2 text-sm font-medium text-text-secondary hover:bg-surface-primary focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:border-border-medium dark:bg-surface-secondary dark:text-text-secondary dark:hover:bg-surface-secondary md:px-4"
            >
              {localize('com_endpoint_export')}
            </button>
            <button
              onClick={submitPreset}
              className="rounded-md bg-brand px-3 py-2 text-sm font-medium text-white hover:bg-brand focus:outline-none focus:ring-2 focus:ring-brand focus:ring-offset-2 md:px-4"
            >
