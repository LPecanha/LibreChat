        ...
        <div className="flex h-full grow items-center justify-end gap-2">
          ...
          <Dialog>
            <DialogTrigger asChild>
              <button
                type="button"
                className="mr-1 flex h-[32px] cursor-pointer items-center rounded bg-transparent px-2 py-1 text-xs font-medium text-gray-600 transition-colors hover:bg-surface-hover hover:text-red-700 focus:ring-ring dark:bg-transparent dark:text-gray-300 dark:hover:bg-surface-hover dark:hover:text-red-700"
