    ...
    <>
      ...
      >
        <div className="flex h-full grow items-center justify-end gap-2">
          <label
            ...
            className="w-40 truncate rounded bg-transparent py-1 text-xs font-medium text-text-secondary transition-colors dark:bg-transparent dark:text-text-secondary sm:w-72"
          >
            {defaultPreset
          ...
          <Dialog>
            <DialogTrigger asChild>
              <button
                type="button"
                className="mr-1 flex h-[32px] cursor-pointer items-center rounded bg-transparent px-2 py-1 text-xs font-medium text-text-secondary transition-colors hover:bg-surface-hover hover:text-red-700 focus:ring-ring dark:bg-transparent dark:text-text-secondary dark:hover:bg-surface-hover dark:hover:text-red-700"
      ...
      {presets && presets.length === 0 && (
        <div
          ...
          tabIndex={-1}
        >
          <div className="flex h-full grow items-center justify-end gap-2 text-text-secondary dark:text-text-secondary">
                      ...
                      <div className="flex h-full items-center justify-end gap-1">
                        <TooltipAnchor
                          ...
                          render={
                            <button
                              className={cn(
                                'm-0 h-full rounded-md bg-transparent p-2 text-text-tertiary hover:text-text-secondary focus:text-text-secondary dark:text-text-tertiary dark:hover:text-gray-200 dark:focus:text-gray-200',
                                defaultPreset?.presetId === presetId
                                  ? ''
                        ...
                        <TooltipAnchor
                          ...
                          render={
                            <button
                              className="m-0 h-full rounded-md p-2 text-text-tertiary hover:text-text-secondary focus:text-text-secondary dark:text-text-tertiary dark:hover:text-gray-200 dark:focus:text-gray-200 sm:invisible sm:group-focus-within:visible sm:group-hover:visible"
                              onClick={(e) => {
                                e.preventDefault();
                                e.stopPropagation();
