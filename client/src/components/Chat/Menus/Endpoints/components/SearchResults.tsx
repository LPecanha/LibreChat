                ...
                {filteredModels.map((model) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {isGlobal && (
                        <EarthIcon className="ml-auto size-4 text-brand" aria-hidden="true" />
                      )}
                      {isModelSelected && (
                        <>
                          <CheckCircle2
            ...
            return (
              ...
              >
                <div className="flex items-center gap-2">
                  {endpoint.icon && (
                    <div
                      className="flex items-center justify-center overflow-hidden rounded-full border border-border-light p-1 dark:border-border-light"
