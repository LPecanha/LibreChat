    ...
    >
      ...
      {showLeftArrow && (
        <button
          type="button"
          onClick={() => scroll('left')}
          className={`absolute left-2 top-1/2 z-20 -translate-y-1/2 rounded-xl bg-white p-2 text-text-primary shadow-lg transition-all duration-200 hover:scale-110 hover:bg-surface-hover hover:shadow-xl active:scale-95 dark:bg-surface-tertiary dark:text-text-primary dark:hover:bg-surface-active ${
      ...
      {showRightArrow && (
        <button
          ...
          className={`absolute right-2 top-1/2 z-20 -translate-y-1/2 rounded-xl bg-white p-2 text-text-primary shadow-lg transition-all duration-200 hover:scale-110 hover:bg-surface-hover hover:shadow-xl active:scale-95 dark:bg-surface-tertiary dark:text-text-primary dark:hover:bg-surface-active ${
            isContainerHovered ? 'opacity-100' : 'pointer-events-none opacity-0'
          }`}
