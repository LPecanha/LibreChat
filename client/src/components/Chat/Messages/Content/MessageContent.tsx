...
const ErrorBox = ({
  ...
  <div
    ...
    aria-live="assertive"
    className={cn(
      'rounded-xl border border-red-500/20 bg-red-500/5 px-3 py-2 text-sm text-text-secondary dark:text-text-primary',
      className,
    )}
  >
    {children}
    ...
    <Container message={message}>
      <div
        className={cn(
          ...
          isCreatedByUser ? 'dark:text-gray-20' : 'dark:text-text-primary',
        )}
      >
        {content}
      </div>
