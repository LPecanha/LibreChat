...
const MinimalMessages = React.forwardRef(
  (
    ...
    return (
      <div
        className={cn(
          'relative flex w-full grow overflow-hidden bg-white dark:bg-surface-secondary',
          props.className,
        )}
      >
        <div className="transition-width relative h-full w-full flex-1 overflow-auto bg-white dark:bg-surface-secondary">
