  ...
  return pageNumber == 1 && pages == 1 ? null : (
    <div className="m-auto mb-2 mt-4 flex items-center justify-center gap-2">
      <button
        ...
        className={
          'btn btn-small bg-transition m-auto flex gap-2 transition hover:bg-surface-secondary disabled:text-gray-300 dark:text-white dark:disabled:text-text-tertiary' +
