...
export function AvatarMenu({
  ...
  return (
    <Popover.Portal>
      <Popover.Content
        className="flex min-w-[100px] max-w-xs flex-col rounded-xl border border-border-medium bg-white shadow-lg dark:border-border-light dark:bg-gray-850 dark:text-white"
        sideOffset={5}
      >
        <div
          role="menuitem"
          className="group m-1.5 flex cursor-pointer gap-2 rounded p-2.5 text-sm hover:bg-surface-hover focus:ring-0 radix-disabled:pointer-events-none radix-disabled:opacity-50 dark:hover:bg-surface-hover dark:hover:bg-white/5"
          tabIndex={-1}
