...
const inputClass = cn(
  defaultTextProps,
  'flex w-full px-3 py-2 dark:border-gray-800 dark:bg-surface-secondary rounded-xl mb-2',
  removeFocusOutlines,
);
      ...
      >
        ...
        <div className="bg-surface-50 h-auto px-4 pb-8 pt-3 dark:bg-transparent">
          ...
          <div className="flex items-center justify-end gap-2">
            ...
            {/* Submit Button */}
            <button
              className="btn btn-primary focus:shadow-outline flex w-full items-center justify-center px-4 py-2 font-semibold text-white hover:bg-brand focus:border-green-500"
              type="submit"
            >
              {submitContext}
            </button>
