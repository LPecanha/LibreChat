  ...
  return (
    <div className="rounded-md border border-border-light p-3">
      <div className="flex items-center justify-between font-medium">
        ...
        {isActive && (
          <span className="rounded-full border border-green-600 bg-brand/20 px-2 py-0.5 text-xs font-medium text-brand dark:border-green-500 dark:bg-green-500/30 dark:text-brand">
